...
public class BackendTest extends Client {
    private final GorestSteps gorestSteps;

    public BackendTest() {
        this.gorestSteps = new GorestSteps();
    }
    ...
    public void backend_casoDeUso1() {
        ...
        GenericRequest requestPostUser = gorestSteps.getPostUserRequest(randomEmail);
        ...
        GenericRequest requestGetUser = gorestSteps.getGetUserRequest(id);
        ...
        GenericRequest requestGetUsers = gorestSteps.getGetUsersRequest();
